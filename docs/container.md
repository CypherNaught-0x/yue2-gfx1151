...
No public **YuE2-tested** base was established by this research, so none is promoted to a default. An existing operator-local ROCm 7.13-era base was used only for the packaging/CPU checks below; it is not represented as publicly downloadable.
